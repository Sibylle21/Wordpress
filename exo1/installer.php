...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20221207_projetpersonnel_d4ec05d6f8dd0fee9880_20221207125849_archive.zip';
        const ARCHIVE_SIZE       = '30375440';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'd4ec05d-07125849';
        const SECONDARY_PACKAGE_HASH = '6ffc3fe-07125849';
        const VERSION            = '1.5.1';
